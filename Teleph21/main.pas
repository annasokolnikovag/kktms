...
procedure TfMain.bWordClick(Sender: TObject);
 var
  WordApp, Doc, WordTable: OLEVariant;
  iRows, iCols: Integer;
begin
...
Doc := WordApp.Documents.Add;
  ...
  WordTable := Doc.Tables.Add(WordApp.Selection.Range, iCols, iRows);

for iRows := 1 to SG.RowCount do
    for iCols := 1 to SG.ColCount do
      SG.Cells[iRows, iCols] :=
        SG.Cells[iCols - 1, iRows - 1];
except
  on E: Exception do
