...
begin
  ...
  try
    {создаем новую книгу  по шаблону p1.xlt}
    Workbook := ExcelApp.Workbooks.Add(ExtractFilePath(Application.ExeName)+'\p1.xlt');
    ...
    {выбираем имя файла для сохранения}
    ...
    Workbook.Close;
    ExcelApp.Quit;
    ShowMessage('Данные успешно экспортированы в Excel!');
  except
    on E: Exception do
